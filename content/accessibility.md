...
| Reader survey card (if enabled) | <kbd>Tab</kbd> · arrows · <kbd>Enter</kbd> / <kbd>Space</kbd> | Tab between the answers and the **Submit** / **No thanks** / **Close** controls; arrows move within a choice group or the rating; <kbd>Enter</kbd> / <kbd>Space</kbd> selects, submits, or dismisses |
...
> checkboxes, a star rating, or a text box) plus **Submit** and a **No thanks** / **Close** pair given
> *distinct* accessible names. As a multi-question survey advances, the new question is announced via an
