...
[Pricing](/pricing/) page is a real generation script that writes a page; the
...
This very site's **[Pricing](/pricing/)** page is built by one generation script:
[`generators/pricing.py`](https://github.com/aardvarkdocs/sample-site/blob/main/generators/pricing.py)
calls **OpenRouter's API** at build time and writes `pricing.md` — a real-world generator that
