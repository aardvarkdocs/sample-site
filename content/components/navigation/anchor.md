...
{% anchor url='/docs/#quickstart' %}Read the quickstart{% endAnchor %} · {% anchor url='https://mantine.dev' text='Mantine' target='_blank' rel='noopener' %}
...
{% raw %}
```aardvark
{% anchor url='/docs/#quickstart' %}Read the quickstart{% endAnchor %}
...
```python
component('aardvark', 'anchor', url='/docs/#quickstart', children='Read the quickstart')
...
Ready to dive in? {% anchor url='/docs/#quickstart' fw='700' %}Open the quickstart{% endAnchor %}.
{% endCallout %}
...
{% accordionSection title="Source: Python" %}
```python
link = component('aardvark', 'anchor', url='/docs/#quickstart', fw='700', children='Open the quickstart')
...
{% anchor url='/docs/#quickstart' attr={'onclick': '''
...
{% accordionSection title="Source: Python" %}
```python
component('aardvark', 'anchor', url='/docs/#quickstart', attr={'onclick': '''
event.preventDefault();
const value = this.innerText;
console.log('attr demo value:', value);
alert(value);
