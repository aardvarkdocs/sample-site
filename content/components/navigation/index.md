...
- [NavLink](/components/navigation/navlink/) — a navigation link with an icon, description, active state, and one level of nested sub-links.
...
These three render automatically from plain Markdown — no tag to learn — but are
documented here too:

- [Steps](/components/navigation/steps/) — numbered Markdown lists become a vertical Steps timeline.
- [Tabs](/components/navigation/tabs/) — switch between Markdown panels with a sliding underline and a crossfade.
- [Tree](/components/navigation/tree/) — a nested file/folder explorer with collapsible folders and per-file source in a modal.
