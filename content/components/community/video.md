...
{% video src='/media/sample.mp4' poster='/landscape.jpg' variant='bordered' autoHideControls=3000 %}
...
{% video src='/media/sample.mp4' poster='/landscape.jpg' attr={'data-onboarding-tour-id': 'player', 'aria-label': 'Product tour video'} %}
