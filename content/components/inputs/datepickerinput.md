...
[data-aardvark-lib="dates"][data-aardvark-island="DatePickerInput"] { }
...
{% datepickerinput label='Ship date' defaultValue='2026-03-09' valueFormat='MMM D, YYYY' clearable=true attr={'onclick': '''
...
```python
component('aardvark', 'datepickerinput', label='Ship date',
          defaultValue='2026-03-09', valueFormat='MMM D, YYYY', clearable=True, attr={'onclick': '''
const value = this.innerText;
console.log('attr demo value:', value);
alert(value);
'''})
