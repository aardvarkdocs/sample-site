...
[data-aardvark-lib="dates"][data-aardvark-island="DateTimePicker"] { }
...
{% datetimepicker label='Starts at' defaultValue='2026-01-15 09:30:00' withSeconds=true valueFormat='MMM D, YYYY HH:mm:ss' clearable=true attr={'onclick': '''
...
component('aardvark', 'datetimepicker', label='Starts at',
          defaultValue='2026-01-15 09:30:00', withSeconds=True,
          valueFormat='MMM D, YYYY HH:mm:ss', clearable=True, attr={'onclick': '''
const value = this.innerText;
console.log('attr demo value:', value);
alert(value);
'''})
