...
(function () {
  ...
  function enhance(table, opts) {
    ...
    // components provide their own table interactivity, so skip them.
    ...
    if (opts.filter) {
      ...
      input.addEventListener('focus', function () {
        wrap.classList.remove('aardvark-search-dismissed');
      });
      input.addEventListener('keydown', function (event) {
        ...
        input.blur();
        wrap.classList.add('aardvark-search-dismissed');
      });
